if(window.snake) {
  window.snake.scheme = function(settings = {}) {
    window.snake.__scheme = settings;
        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            if(settings.burger || settings.cactus || settings.hotdog || settings.egg || settings.lime || settings.red_pepper || settings.cane) {
              ...
              settings.cane       && document.querySelector('#apple').appendChild(cane);
              settings.cracker    && document.querySelector('#apple').appendChild(cracker);
              settings.tree       && document.querySelector('#apple').appendChild(tree);
              ...
              eval(
                code.match(
                  ...
                  '{',
                  `{
                    ${HZ} = [...document.querySelector('#apple').children].map(e => [{oa: { canvas: e } }][0]);
              ...
              eval(
                code.match(
                  ...
                  `Math.floor((21 + ~~${settings.burger} + ~~${settings.cactus} + ~~${settings.hotdog} + ~~${settings.egg} + ~~${settings.lime} + ~~${settings.red_pepper} + ~~${settings.cane}) * Math.random());`
                )
              );
            }
